...
class AFN
  ...
  def cerradura_kleene
    ...
    @transiciones << { estado_origen: new_state, simbolo: 'ε', estados_destino: [estado_inicial] }
    @transiciones << { estado_origen: new_state, simbolo: 'ε', estados_destino: estados_aceptacion.first }
...
archivo_afn_modificado = 'AFN_POR_cerradura.txt'
